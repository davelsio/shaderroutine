...
/**
 * Creates the fragment shader and its uniforms.
 * Call this with the TypeGPU root once it's initialized.
 */
export function createFragmentShader(root: TgpuRoot) {
  ...
  /** Seconds passed since the start of the example */
